...
base_dir = f"../test_result/accumlated_4var/{Control_Var_name}_t=0-{Objective_T_period}_{Control_X_size}*{Control_Y_size}*{Control_Z_size}grids_FET={opt_num}_trials={trial_base}-{trial_base+trial_num-1}_{current_time}"
